    ...
    return (
      <div className={`bg-white mt-[7vh] md:mt-[10vh] 3xl:mt-0  ${heroStyles.container}`} >
          <div className={heroStyles.overlay}>
             <div className={` h-[90%] bg-green-700 md:mt-[15vh] md:h-[60%] lg:h-[50%] 2xl:h-[60%] lg:w-[70%] xl:w-[38%] ml-[4%] ${heroStyles.gen}`}>
              <div className={`h-[70%] flex flex-col justify-between text-white ${heroStyles.textsCont}`}>
                ...
                <p className={`w-[87%] font-openSans font-[500] text-[13px] md:text-[16px] leading-[18px] md:leading-[22px] ${heroStyles.textBody}`}>Make well-informed decision by improving your <br /> verification process by making VeriFyer do the job for you <br /> in secure, fast and reliable way.</p>
              </div>
